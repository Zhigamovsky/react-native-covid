...
export interface HttpContextWeatherActions {
  // GET_WEATHER_BY_CITY: HttpContextAction<any, any> //HttpContextAction<RequestData<WeatherByCity>, WeatherByCityResponseData>,
  // GET_WEATHER_BY_COORDS: HttpContextAction<any, any>  //HttpContextAction<RequestData<WeatherByCoords>, WeatherByCoordsResponseData>
}
